...
A stripped down version of the TDaemon for the Cryogenic 16T. This omits the parts for control of the helium pot
...
class TControl():
	...
	def __init__(self):
		...
		# For 16T there are 2 heater outputs main heater = VTI, Analog 1 = 4He Pot
		# Analog 2 = Probe
...
if __name__ == '__main__':
	...
	#Initialize Keithley 2700 for He pot temperature
	TKeithley=visa.instrument("COM4")
	Tpot=TKeithley.ask("MEAS?")
